[SedimentFileInformation]
   ...
   FileCreationDate = Wed Dec 10 2014, 10:35:04         
   FileVersion      = 02.00                        
[SedimentOverall]
...
[Sediment]
   ...
   TcrSed           =  1.5000000e-001      [N/m2]   Critical bed shear stress for sedimentation (uniform value or filename)
   TcrEro           =  1.5000000e-001      [N/m2]   Critical bed shear stress for erosion       (uniform value or filename)
   EroPar           =  5.0000000e-004      [kg/m2/s] Erosion parameter                           (uniform value or filename)
   CDryB            =  1.0000000e+003      [kg/m3]  Dry bed density
